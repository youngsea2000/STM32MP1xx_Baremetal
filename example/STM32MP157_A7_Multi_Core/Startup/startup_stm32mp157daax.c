/**
  ******************************************************************************
  * @file    startup_stm32mp157dxx_ca7.c
...
void __attribute__ ((weak)) PMUIRQ1_IRQHandler(void) {}
void __attribute__ ((weak)) COMMRX0_IRQHandler(void) {}
void __attribute__ ((weak)) COMMRX1_IRQHandler(void) {}
void __attribute__ ((weak)) COMMTX0_IRQHandler(void) {}
void __attribute__ ((weak)) COMMTX1_IRQHandler(void) {}
...
void __attribute__ ((weak)) nCTIIRQ1_IRQHandler(void) {}
...
IRQHandler_t IRQ_Vector_Table[MAX_IRQ_n] = {
    ...
    EXTI15_IRQHandler,
    MDMA_SEC_IT_IRQHandler,             /* 160 */
    SYSRESETQ_IRQHandler,
    TIM13_IRQHandler,
    TIM14_IRQHandler,
    DAC_IRQHandler,
    RNG1_IRQHandler,
    ...
    RESERVED_IRQHandler,
    RESERVED_IRQHandler,
    TAMP_SERR_S_IRQHandler,
    RTC_WKUP_ALARM_S_IRQHandler,        /* 230 */
    RTC_TS_SERR_S_IRQHandler,
    PMUIRQ0_IRQHandler,
    PMUIRQ1_IRQHandler,
    RESERVED_IRQHandler,
    RESERVED_IRQHandler,
