/**
  ...
  * @file    stm32mp1xx_atk.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage LEDs,
  *          push-buttons and COM ports available on STM32MP1xx-ATK board
  *          from ALIENTEK.
  *
  @verbatim
  *
...
/** @defgroup STM32MP1XX_ATK_LOW_LEVEL_Private_TypesDefinitions Private Typedef
  * @{
  */
...
/** @defgroup STM32MP1XX_ATK_LOW_LEVEL_Private_Defines Private Def
  * @{
  */

/** @brief STM32MP1XX ATK BSP Driver version number V0.0.2
  */
#define STM32MP1XX_ATK_BSP_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define STM32MP1XX_ATK_BSP_VERSION_SUB1   (0x00U) /*!< [23:16] sub1 version */
#define STM32MP1XX_ATK_BSP_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define STM32MP1XX_ATK_BSP_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define STM32MP1XX_ATK_BSP_VERSION         ((STM32MP1XX_ATK_BSP_VERSION_MAIN << 24)\
                                             |(STM32MP1XX_ATK_BSP_VERSION_SUB1 << 16)\
                                             |(STM32MP1XX_ATK_BSP_VERSION_SUB2 << 8 )\
                                             |(STM32MP1XX_ATK_BSP_VERSION_RC))
/**
  * @}
  */


/** @defgroup STM32MP1XX_ATK_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */

static GPIO_TypeDef* LED_PORT[LEDn] = {LED0_GPIO_PORT,
                                       LED1_GPIO_PORT,
                                      };

static const uint16_t LED_PIN[LEDn] = {LED0_PIN,
                                       LED1_PIN,
                                      };
...
/** @defgroup STM32MP1XX_ATK_LOW_LEVEL_Private_FunctionPrototypes Private Prototypes
  * @{
  */
#ifdef HAL_EXTI_MODULE_ENABLED
...
/** @addtogroup STM32MP1XX_ATK_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */

  /**
  * @brief  This method returns the STM32MP1XX ATK BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return STM32MP1XX_ATK_BSP_VERSION;
}
...
/**
  ...
  *            @arg  BUTTON_KEY0: KEY0 Push Button
...
int32_t BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  int32_t  status = BSP_ERROR_NONE;
  GPIO_InitTypeDef      gpio_init_structure;
  static uint32_t  BSP_BUTTON_IT_PRIORITY[BUTTONn] = {BSP_BUTTON_WAKEUP_IT_PRIORITY, BSP_BUTTON_KEY0_IT_PRIORITY, BSP_BUTTON_KEY1_IT_PRIORITY};
#ifdef HAL_EXTI_MODULE_ENABLED
  static uint32_t  BUTTON_EXTI_LINE[BUTTONn]   = {WAKEUP_BUTTON_EXTI_LINE, KEY0_BUTTON_EXTI_LINE, KEY1_BUTTON_EXTI_LINE};
  static BSP_EXTI_LineCallback  ButtonCallback[BUTTONn]     = {BUTTON_WAKEUP_EXTI_Callback, BUTTON_KEY0_EXTI_Callback, BUTTON_KEY1_EXTI_Callback};
#endif
  ...
  case BUTTON_WAKEUP:
    ...
    break;
  case BUTTON_KEY0:
    /* BUTTON_KEY0 clock enable */
    KEY0_BUTTON_GPIO_CLK_ENABLE();
    break;
  case BUTTON_KEY1:
    /* BUTTON_KEY1 clock enable */
  ...
  if(ButtonMode == BUTTON_MODE_GPIO)
  {
    ...
    // gpio_init_structure.Pull = GPIO_PULLUP;
    gpio_init_structure.Pull = (Button == BUTTON_WAKEUP)?GPIO_PULLDOWN:GPIO_NOPULL;
  ...
  else /*(ButtonMode == BUTTON_MODE_EXTI) */
  {
    ...
    gpio_init_structure.Pull = (Button == BUTTON_WAKEUP)?GPIO_PULLDOWN:GPIO_NOPULL;
    gpio_init_structure.Speed = GPIO_SPEED_FREQ_HIGH;
    gpio_init_structure.Mode = (Button == BUTTON_WAKEUP)?GPIO_MODE_IT_RISING:GPIO_MODE_IT_FALLING;
    BSP_ENTER_CRITICAL_SECTION(BUTTON_PORT[Button]);
    HAL_GPIO_Init(BUTTON_PORT[Button], &gpio_init_structure);
    BSP_EXIT_CRITICAL_SECTION(BUTTON_PORT[Button]);
    ...
    if (HAL_EXTI_RegisterCallback(&hExtiButtonHandle[Button], HAL_EXTI_FALLING_CB_ID, ButtonCallback[Button]) != HAL_OK)
    {
      status = BSP_ERROR_PERIPH_FAILURE;
    }
#endif
...
{
  return (int32_t) HAL_GPIO_ReadPin(BUTTON_PORT[Button], BUTTON_PIN[Button])^(Button == BUTTON_WAKEUP);
}
...
{
  HAL_EXTI_IRQHandler(&hExtiButtonHandle[BUTTON_KEY0]);
}
...
/** @addtogroup STM32MP1XX_ATK_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */

#ifdef HAL_EXTI_MODULE_ENABLED
/** @addtogroup STM32MP1XX_ATK_LOW_LEVEL_Private_Functions_Group1 BUTTON Functions
  * @{
  */
...
/**
  * @brief  KEY0 EXTI line detection callbacks.
  * @retval None
  */
static void BUTTON_KEY0_EXTI_Callback(void)
{
  BSP_PB_Callback(BUTTON_KEY0);
}

/**
  * @brief  KEY1 EXTI line detection callbacks.
  * @retval None
  */
static void BUTTON_KEY1_EXTI_Callback(void)
{
  BSP_PB_Callback(BUTTON_KEY1);
}
...
#if (USE_BSP_COM_FEATURE == 1)
#ifdef HAL_UART_MODULE_ENABLED
/** @addtogroup STM32MP1XX_ATK_LOW_LEVEL_Private_Functions_Group2 COM Functions
  * @{
  */
/**
