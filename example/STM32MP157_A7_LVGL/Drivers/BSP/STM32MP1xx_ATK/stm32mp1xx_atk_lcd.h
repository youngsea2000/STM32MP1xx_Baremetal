/**
  ******************************************************************************
  * @file    stm32mp1xx_atk_lcd.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32mp1xx_atk_lcd.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32MP1xx_ATK_LCD_H
#define __STM32MP1xx_ATK_LCD_H
...
/** @defgroup STM32MP1xx_ATK_LCD_Exported_Types STM32MP1xx_ATK_LCD Exported Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32MP1xx_ATK_LCD_Exported_Constants STM32MP1xx_ATK_LCD Exported Constants
  * @{
  */
...
/**
  ...
  */
/* LCD ID M0 pin */
#define LCD_ID_M0_PIN                         GPIO_PIN_6
#define LCD_ID_M0_GPIO_PORT                   GPIOJ
#define LCD_ID_M0_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOJ_CLK_ENABLE()
#define LCD_ID_M0_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOJ_CLK_DISABLE()

/* LCD ID M1 pin */
#define LCD_ID_M1_PIN                         GPIO_PIN_2
#define LCD_ID_M1_GPIO_PORT                   GPIOK
#define LCD_ID_M1_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOK_CLK_ENABLE()
#define LCD_ID_M1_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOK_CLK_DISABLE()

/* LCD ID M2 pin */
#define LCD_ID_M2_PIN                         GPIO_PIN_6
#define LCD_ID_M2_GPIO_PORT                   GPIOK
#define LCD_ID_M2_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOK_CLK_ENABLE()
#define LCD_ID_M2_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOK_CLK_DISABLE()
...
/** @addtogroup STM32MP1xx_ATK_LCD_Exported_Functions
  * @{
  */
/* Initialization APIs */
